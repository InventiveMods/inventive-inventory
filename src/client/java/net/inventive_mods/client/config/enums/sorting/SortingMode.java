package net.inventive_mods.client.config.enums.sorting;
...
public enum SortingMode implements Translatable {
    NAME("name", Comparator.comparing(slot -> InteractionHandler.getStackFromSlot(slot).getDisplayName().getString())),
    ...
    public Comparator<Integer> getComparator() {
        return this.comparator
                ...
                .thenComparing(slot -> {
                    ...
                    if (component == null) component = stack.get(DataComponents.ENCHANTMENTS);
                    if (component != null) {
                        ItemEnchantments finalComponent = component;
                        return component.keySet()
                                .stream()
                                .map(entry -> Enchantment.getFullname(entry, 0).getString() + " " + finalComponent.getLevel(entry))
