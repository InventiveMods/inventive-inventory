package net.inventive_mods.client.config;
...
import net.inventive_mods.client.config.enums.sorting.SortingMode;
import net.inventive_mods.client.config.options.ConfigOption;
import net.inventive_mods.client.config.options.buttons.EnumButtonOption;
import net.inventive_mods.client.config.options.buttons.SimpleButtonOption;
...
public class ConfigManager {
    public static final Path CONFIG_PATH = FabricLoader.getInstance().getConfigDir().resolve(InventiveInventoryClient.MOD_ID);
    ...
    public static void save() {
        try {
            ...
            for (StackTraceElement traceElement : ex.getStackTrace()) {
                InventiveInventoryClient.LOGGER.error(traceElement.toString());
            }
        }
