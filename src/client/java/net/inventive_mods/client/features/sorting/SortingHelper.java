...
class SortingHelper {
    ...
    public static void mergeItemStacks(SlotRange slotRange) {
        ...
        for (int slot : slotRange) {
            ...
            if (!stack.isEmpty() && stack.getCount() < stack.getMaxStackSize()) {
                for (int followingSlot : followingSlots) {
                    ...
                    if (ItemStackUtils.areEqualWithoutCount(stack, followingStack) && followingStack.getCount() < followingStack.getMaxStackSize()) {
        ...
        if (InteractionHandler.isCursorFull()) {
            ...
            } else if (ItemStackUtils.areEqualWithoutCount(InteractionHandler.getStackFromSlot(slotRange.getLast()), InteractionHandler.getCursorStack())) {
