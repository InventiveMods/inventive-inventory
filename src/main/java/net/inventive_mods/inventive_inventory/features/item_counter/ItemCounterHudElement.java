...
public class ItemCounterHudElement implements LayeredDrawer.Layer {
    public static Identifier IDENTIFIER = Identifier.of(InventiveInventory.MOD_ID, "item_counter_hud_element");
